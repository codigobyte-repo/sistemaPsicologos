    ...
    <nav class="flex" aria-label="Breadcrumb">
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <div class="flex items-center">
                ...
                <span class="ml-1 text-sm font-medium text-white md:ml-2 dark:text-white">Mis cuentas</span>
            </div>
            </li>
        </ol>
    </nav>
...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="overflow-hidden sm:rounded-lg">
            ...
            @if ($userPagos->isNotEmpty() AND $userPagos[0]['visto'] == 1)
                ...
                <div id="alert-additional-content-2" class="p-4 mb-4 text-red-800 border border-red-300 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400 dark:border-red-800" role="alert">
                    ...
                    <h3 class="text-lg font-medium">Tiene un pago rechazado</h3>
                    </div>
            ...
            <div id="alert-additional-content-3" class="p-4 mb-4 text-green-800 border border-green-300 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400 dark:border-green-800" role="alert">
                <div class="flex items-center">
                  ...
                  <span class="sr-only">Info</span>
                  <h3 class="text-lg font-medium">¡Excelente! no tiene anuncios de pagos rechazados</h3>
                </div>
                <div class="mt-2 mb-4 text-sm">
                  Si hay un inconveniente con algún anuncio de pago usted podrá visualizar aquí el problema. <br/><br/>
                  Si desea verificar anuncios anteriores puede hacerlo desde aquí: 
                  <a class="text-blue-900 font-bold" href="{{ route('mis-comprobantes') }}"> 
                    <<< Mis Pagos >>> 
                  </a>
                </div>
            </div>
