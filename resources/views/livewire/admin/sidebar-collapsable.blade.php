<div class="bg-violet-500 dark:bg-gray-950 rounded p-3 shadow-lg absolute z-50" x-bind:class="{ 'w-60': isOpen || isButtonClicked }" @mouseover="isOpen = true" @mouseleave="isOpen = false" x-data="{ isOpen: false, isButtonClicked: false }">
    ...
    <ul class="space-y-2 text-sm">
        ...
        @can('admin.matriculados.index')
            ...
            <li>
                <a href="{{ url('admin/users') }}" class="flex items-center space-x-3 text-gray-300 p-2 rounded-md font-medium hover:bg-violet-800 dark:hover:bg-gray-600 dark:focus:bg-gray-800 focus:shadow-outline {{ request()->routeIs('admin.users.index') ? 'bg-violet-600 dark:bg-gray-800' : '' }}">
                    ...
                    <span x-show="isOpen">Usuarios y Roles</span>
                </a>
        ...
        @can('admin.control-pagos.index')
            ...
            <li x-show="isOpen" class="py-1 pl-1 text-white dark:text-gray-500 uppercase text-xs tracking-wide">ADM. DE COBROS</li>
            <li>
                @can('admin.control-pagos.index')
                    <a href="{{ url('admin/control-pagos') }}" class="flex items-center space-x-3 text-gray-300 p-2 rounded-md font-medium hover:bg-violet-800 dark:hover:bg-gray-600 dark:focus:bg-gray-800 focus:shadow-outline {{ request()->routeIs('admin/control-pagos') ? 'bg-violet-600 dark:bg-gray-800' : '' }}">
                        <span class="text-gray-300">
                            <svg class="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0A50.697 50.697 0 0112 13.489a50.702 50.702 0 017.74-3.342M6.75 15a.75.75 0 100-1.5.75.75 0 000 1.5zm0 0v-3.675A55.378 55.378 0 0112 8.443m-7.007 11.55A5.981 5.981 0 006.75 15.75v-1.5" />
                            </svg>
                        </span>
                        <span x-show="isOpen">Control de pagos</span>
                    </a>
                @endcan
                ...
                @can('admin.configuracion-matricula')
                    <ul>
                        <li x-show="isOpen" class="{{ request()->routeIs('admin.matriculados.create') ? 'bg-violet-600 dark:bg-gray-800 rounded-md' : '' }}">
                            <a href="{{ url('admin/precio-servicios') }}" x-bind:class="{ 'm-4': isOpen }" class="flex items-center space-x-3 text-gray-300 p-2 rounded-md font-medium hover:bg-violet-800 dark:hover:bg-gray-600 dark:focus:bg-gray-800 focus:shadow-outline">
                                <span class="text-gray-300">
                                    <svg class="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M19 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM4 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 0110.374 21c-2.331 0-4.512-.645-6.374-1.766z" />
                                    </svg>                              
        ...
        @can('admin.matriculados.index')
            ...
            <li>
                <a href="{{ url('admin/roles') }}" class="flex items-center space-x-3 text-gray-300 p-2 rounded-md font-medium hover:bg-gray-600 focus:bg-gray-800 focus:shadow-outline">
                    <span class="text-gray-300">
                        <svg class="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 12.75L11.25 15 15 9.75m-3-7.036A11.959 11.959 0 013.598 6 11.99 11.99 0 003 9.749c0 5.592 3.824 10.29 9 11.623 5.176-1.332 9-6.03 9-11.622 0-1.31-.21-2.571-.598-3.751h-.152c-3.196 0-6.1-1.248-8.25-3.285z" />
                        </svg>                      
                    </span>
                    <span x-show="isOpen">Roles del sistema</span>
                </a>
                @can('admin.users.create')
                    <ul>
                        <li x-show="isOpen" class="{{ request()->routeIs('admin.roles.create') ? 'bg-violet-600 dark:bg-gray-800 rounded-md' : '' }}">
                            <a href="{{ url('admin/roles/create') }}" x-bind:class="{ 'm-4': isOpen }" class="flex items-center space-x-3 text-gray-300 p-2 rounded-md font-medium hover:bg-violet-800 dark:hover:bg-gray-600 dark:focus:bg-gray-800 focus:shadow-outline">
                                <span class="text-gray-300">
                                    <svg class="h-5" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6">
                                        <path stroke-linecap="round" stroke-linejoin="round" d="M19 7.5v3m0 0v3m0-3h3m-3 0h-3m-2.25-4.125a3.375 3.375 0 11-6.75 0 3.375 3.375 0 016.75 0zM4 19.235v-.11a6.375 6.375 0 0112.75 0v.109A12.318 12.318 0 0110.374 21c-2.331 0-4.512-.645-6.374-1.766z" />
                                    </svg>                              
        ...
        <li>
            <a href="{{ url('user/profile') }}" class="flex items-center space-x-3 text-gray-300 p-2 rounded-md font-medium hover:bg-gray-600 focus:bg-gray-800 focus:shadow-outline">
                <span class="text-gray-300">
