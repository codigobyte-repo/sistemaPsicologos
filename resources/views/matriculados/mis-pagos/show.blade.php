            ...
            <ol class="inline-flex items-center space-x-1 md:space-x-3">
              ...
              {{-- <li>
                <div class="flex items-center">
                  ...
                  <a href="#" class="ml-1 text-sm font-medium text-white hover:text-blue-600 md:ml-2 dark:text-white dark:hover:text-white">Projects</a>
                </div>
              </li> --}}
              <li aria-current="page">
                <div class="flex items-center">
                  <svg aria-hidden="true" class="w-6 h-6 text-white" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l-4 4a1 1 0 01-1.414 0z" clip-rule="evenodd"></path></svg>
                  <span class="ml-1 text-sm font-medium text-white md:ml-2 dark:text-white">Mis anuncios de pagos</span>
                </div>
              </li>
            </ol>
        </nav>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="overflow-hidden sm:rounded-lg">
                ...
                @livewire('matriculados.mis-comprobantes')
