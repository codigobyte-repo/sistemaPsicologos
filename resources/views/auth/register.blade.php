<x-guest-layout>
    <x-authentication-card>
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="mb-4">
                <x-label for="lastname" label="Apellido" />
            ...
            <div>
                <x-label for="matricula" label="Matrícula" />
                <x-input id="matricula" class="block mt-1 w-full" type="text" name="matricula" :value="old('matricula')" required autofocus autocomplete="matricula" />
            </div>
